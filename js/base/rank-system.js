...
export default class RankSystem {
    ...
    animateAvator(user) {
        ...
        this.loader.load(user.headimg, (texture) => {
            if (this.hitPoint.uuid == this.game.nextBlock.obj.uuid) {
                this.hitPoint.ready = true;
                texture.minFilter = THREE.LinearFilter;
                this.hitPoint.texture = texture;
            }
        });
    }
    ...
    playAnimate() {
        ...
        Animation.customAnimation.to(this.obj.position, 0.4, {
            y: AnimateHeight + AvatorY
        });
        Animation.customAnimation.to(this.text.material, 0.4, {
            opacity: 1
        });
        Animation.customAnimation.to(this.avatorOuter.material, 0.4, {
            opacity: 1
        });
        Animation.customAnimation.to(this.avatorFrame.material, 0.4, {
            opacity: 1
        });
